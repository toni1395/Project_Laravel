...
<html lang="en">
  ...
  <body>
            ...
            <div class="row">
            <div class="col-8">
                  <h1 class="mt-3">Form Tambah Pertanyaan & Jawaban</h1>
                ...
                <input type="text" class="form-control  @error ('pertanyaan') is-invalid @enderror" id="jawaban" placeholder="masukan jawaban" name="jawaban" value="{{old('jawaban')}}">
                @error('jawaban')
                 <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
